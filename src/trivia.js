...
function validarResultado() {
  ...
  if (p1Respuesta === "1") {
    ...
    mensajeTrivia1 =
      "Incorrecto! La respuesta es " + respuestasCorrectasTexto[0];
  }
  if (p2Respuesta === "1") {
    mensajeTrivia2 = "Correcto!";
  } else {
    mensajeTrivia2 =
      "Incorrecto! La respuesta es " + respuestasCorrectasTexto[1];
  }
  if (p3Respuesta === "1") {
    mensajeTrivia3 = "Correcto!";
  } else {
    mensajeTrivia3 =
      "Incorrecto! La respuesta es " + respuestasCorrectasTexto[2];
  }
